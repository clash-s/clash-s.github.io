...
new_basename = ""
current_random_speed = f"{round(random.uniform(10.0, 15.0), 1)}M/S"
    ...
    <main>
        ...
        <div id="apork-hero" class="apork-hero-area hero-bg position-relative">
            <div class="hero-style-shape">
                <img class="style-shape shape-1" src="/assets/website/img/clash-s/shape-1.png" alt="" />
                <img class="style-shape shape-2" src="/assets/website/img/clash-s/shape-2.png" alt="" />
                <img class="style-shape aporkrot shape-3" src="/assets/website/img/clash-s/shape-3.png" alt="" />
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-8 col-md-12">
                        <div class="hero-content">
                            <h2>最新 Clash-S节点订阅</h2>
                            <p>Clash Verge是代理工具Clash内核的GUI图形客户端，支持Windows、Linux、macOS系统，分流规则功能强大且支持多种代理协议，如V2Ray、Trojan、Shadowsocks、ShadowsocksR、Socks等协议。</p>
                        </div>
                    </div>
                    <div class="col-xl-4 offset-xl-1 col-lg-4">
                        <div class="hero-mobile-img">
                            <img src="/assets/website/img/clash-s/hero-mobile-1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
